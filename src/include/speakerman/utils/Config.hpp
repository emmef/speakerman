...
namespace speakerman {
    ...
    struct config
    {
         ...
         */
        typedef CallbackResult (*configReaderCallback)(const char *key, const char *value, void *data);
        ...
        static constexpr bool isAssignment(char c)
        {
            return c == '=' || c == ':';
        }
        ...
        static constexpr bool isEscape(char c)
        {
            return c == '\\';
        }
        ...
        public:
            ...
            ReadResult readFile(const char *fileName, configReaderCallback callback, void *data)
            {
                std::ifstream stream;
        ...
        {
            static CallbackResult callback(const char *key, const char *value, void *data)
            {
