#ifndef SPEAKERMAN_M_DYNAMIC_PROCESSOR_LEVELS_H
#define SPEAKERMAN_M_DYNAMIC_PROCESSOR_LEVELS_H
/*
...
class DynamicProcessorLevels {
  double signal_square_[ProcessingGroupsConfig::MAX_GROUPS + 1];
  size_t channels_;
  size_t count_;
...
#endif // SPEAKERMAN_M_DYNAMIC_PROCESSOR_LEVELS_H
