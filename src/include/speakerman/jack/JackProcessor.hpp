...
namespace speakerman {
    ...
    struct ProcessingMetrics
    {
        ...
        static ProcessingMetrics withRate(jack_nframes_t r)
        { return {r, 0}; }
    ...
    public:
         ...
         */
        const jack_nframes_t getSampleRate() const
        { return metrics_.sampleRate; }
         ...
         *
         */
        const jack_nframes_t getBufferSize() const
        { return metrics_.bufferSize; }
