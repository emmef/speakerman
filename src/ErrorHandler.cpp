...
void ErrorHandler::clear() { message_ = nullptr; }
...
void ErrorHandler::setForceLogNext() { ErrorHandler::force_log_ = true; }

const char *ErrorHandler::get_message() { return message_; }
